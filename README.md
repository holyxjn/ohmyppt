...
[English](./README_EN.md) | [为什么做这个](#why) • [能做什么](#features) • [使用流程](#workflow) • [更新日志](./CHANGELOG.md) • [使用问题](#usage-notes)
  ...
  [观看原项目演示视频](https://arcsin1.github.io/ohmyppt2.mp4) | [下载本改版安装包](https://github.com/holyxjn/ohmyppt/releases)
</div>

---

> 本仓库是基于 [arcsin1/oh-my-ppt](https://github.com/arcsin1/oh-my-ppt) 的非官方改版，遵循 MIT License，并保留原作者版权声明。当前改版重点补充了本地 HTML 导入、可编辑 PPTX 导出优化、导出预览等能力。
...
ohmyppt 的页面是 HTML 幻灯片，内置本地 **Anime.js v4** 动画运行时。生成或编辑页面时，可以让 AI 为页面里的整块元素添加基础演示动画，例如标题、数据卡片、图片、图表容器、步骤模块等。
...
> 建议只从本仓库 Release 地址下载安装包，避免使用第三方转存文件。

<a id="feedback"></a>
## 🙌 需求反馈

如果你使用的是本改版，有新需求、功能建议或发现问题，建议在本仓库提交 Issue。原项目问题请前往 [arcsin1/oh-my-ppt](https://github.com/arcsin1/oh-my-ppt) 反馈。
...
本项目基于 [arcsin1/oh-my-ppt](https://github.com/arcsin1/oh-my-ppt) 修改，遵循 [MIT License](LICENSE)。原始版权声明：© 2026 arcsin1 &lt;zy19931129@gmail.com&gt;。本仓库不是原项目官方发布版本。
