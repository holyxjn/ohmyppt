export const zh = {
  ...
  home: {
    ...
    documentSingleOnly: '一次只能上传一个文档，请重新选择。',
    documentCountExceeded: '文档数量超出限制',
    documentTooLargeTitle: '文档过大',
    documentTooLarge: '单个文档不能超过 {maxSize}MB，请压缩或拆分后再上传。',
    documentPathFailedTitle: '无法读取文档路径',
    documentPathFailed: '无法读取文档路径，请重新选择本地文档。',
    documentParsed: '文档解析完成',
    documentParsedDescription: '已整理 {count} 个文档并填入主题、页数和详细描述',
  ...
  settings: {
    ...
    modelSaved: '模型设置已保存',
    modelSavedDescription: 'Provider、model、base_url 和 api_key 已写入本地',
...
- 不要出现闪烁、眩晕感强的动画`
  ...
  generating: {
    ...
    created: '生成任务已创建，正在启动引擎...',
    currentSession: '当前会话',
    defaultPrompt: '请生成一份结构清晰、可直接预览的演示文稿初稿。',
    pageDone: '第 {pageNumber} 页已完成：{title}',
    completed: '整份演示已生成完成。',
    failedRetryOrBack: '生成失败，请点击重试或返回会话列表。',
    stillRunning: '检测到该会话仍在后台生成，已恢复连接。',
    started: '任务已启动，正在逐页生成中...',
    failed: '生成失败',
    previousFailed: '该会话上一次生成失败，你可以直接重试。',
    keptFailed: '检测到该会话未成功完成，保留在生成页以便继续处理。',
    resumed: '检测到任务仍在后台运行，已恢复实时进度。',
    incompleteSome: '会话尚未完成：已完成 {generated}/{total} 页。请选择继续生成剩余页。',
    continueRemainingEvent: '检测到会话部分完成。请继续生成剩余页。',
    incompleteNone: '会话尚未完成：当前 0/{total} 页。请重新生成。',
    noValidPagesEvent: '检测到会话尚未产出有效页面。请重新生成。',
    backHome: '返回首页',
    title: 'AI 正在生成你的创意',
    expandLog: '展开日志面板',
    collapseLog: '收起日志面板',
  ...
  sessionDetail: {
    ...
    mainContext: '主会话 · 用于全局结构与 index 调整',
