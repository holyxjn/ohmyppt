export const zh = {
  ...
  home: {
    ...
    importHtml: '导入 HTML 转 PPT',
    importingHtml: 'HTML 导入中',
    importHtmlTooltip:
      '支持导入 .html / .htm 文件，单个不超过 {maxSize}MB。导入后会生成可预览会话，可继续编辑并导出 PPTX。',
    parsed: '已解析',
    ...
    htmlSingleOnlyTitle: 'HTML 数量超出限制',
    htmlSingleOnly: '一次只能导入一个 HTML 文件。',
    unsupportedHtml: '请上传 .html 或 .htm 文件。',
    htmlTooLargeTitle: 'HTML 文件过大',
    htmlTooLarge: '单个 HTML 文件不能超过 {maxSize}MB。',
    htmlPathFailedTitle: '无法读取 HTML 路径',
    htmlPathFailed: '请重新选择本地 HTML 文件。',
    htmlPreparing: '正在准备导入 HTML...',
    htmlImportDone: 'HTML 导入完成',
    htmlImportedWithWarnings: '已导入 {pageCount} 页，存在 {warningCount} 条提示。',
    htmlImported: '已导入 {pageCount} 页。',
    htmlImportFailed: 'HTML 导入失败'
  },
  sessions: {
    eyebrow: 'Sessions',
    title: '会话列表',
...
- 不要出现闪烁或大范围抖动的动画效果`
  ...
  sessionDetail: {
    ...
    pptxPreparing: '正在准备可编辑 PPTX',
    pptxPreparingDescription: '会尽量保留版式、颜色和图片效果，同时让主要文字可继续编辑。',
    pptxExported: 'PPTX 已导出（{count} 页）',
    pptxEditableDescription: '已尽量保留版式与可编辑文字。',
    pptxPreviewPreparing: '正在生成 PPTX 预览稿',
    pptxPreviewDescription: '会生成临时 PPTX 并自动打开，不会覆盖正式导出文件。',
    pptxPreviewReady: 'PPTX 预览稿已生成（{count} 页）',
    pptxPreviewOpened: '已打开临时预览文件，确认效果后可再正式导出。',
    previewPptx: '预览 PPTX',
    exportPptxDefault: '高保真导出',
    exportPptxEditableShapes: '形状可编辑',
    exportPptxTextOnly: '仅文字',
    exportPptxWithImages: '文字 + 图片',
    history: '版本历史',
