...
export const en = {
  ...
  settings: {
    ...
    modelSavedDescription: 'Provider, model, base_url, and api_key have been written locally',
...
- Do not create flicker or disorienting motion`
  ...
  generating: {
    ...
    created: 'Generation task created. Starting engine...',
    currentSession: 'Current session',
    defaultPrompt: 'Create a clear first draft that can be previewed directly.',
    pageDone: 'Page {pageNumber} completed: {title}',
    completed: 'The full presentation has been generated.',
    failedRetryOrBack: 'Generation failed. Retry or return to the session list.',
    stillRunning: 'This session is still generating in the background. Connection restored.',
    started: 'Task started. Generating page by page...',
    failed: 'Generation failed',
    previousFailed: 'The previous generation for this session failed. You can retry directly.',
    keptFailed: 'This session did not complete successfully and remains on the generation page.',
    resumed: 'Background generation detected. Live progress restored.',
    incompleteSome:
      'Session incomplete: {generated}/{total} pages finished. Continue generating the remaining pages.',
    continueRemainingEvent: 'Partial session detected. Continue generating the remaining pages.',
    incompleteNone: 'Session incomplete: 0/{total} pages finished. Please regenerate.',
    noValidPagesEvent: 'No valid pages were produced. Please regenerate.',
    backHome: 'Back home',
