...
export const en = {
  ...
  home: {
    ...
    importHtml: 'Import HTML to PPT',
    importingHtml: 'Importing HTML...',
    importHtmlTooltip:
      'Import a .html / .htm file up to {maxSize}MB. It becomes a previewable session that can be edited and exported to PPTX.',
    parsed: 'Parsed',
    ...
    htmlSingleOnlyTitle: 'Too many HTML files',
    htmlSingleOnly: 'Import one HTML file at a time.',
    unsupportedHtml: 'Please upload a .html or .htm file.',
    htmlTooLargeTitle: 'HTML file too large',
    htmlTooLarge: 'A single HTML file must be under {maxSize}MB.',
    htmlPathFailedTitle: 'Cannot read HTML path',
    htmlPathFailed: 'Please choose a local HTML file again.',
    htmlPreparing: 'Preparing HTML import...',
    htmlImportDone: 'HTML imported',
    htmlImportedWithWarnings: 'Imported {pageCount} pages with {warningCount} warning(s).',
    htmlImported: 'Imported {pageCount} pages.',
    htmlImportFailed: 'Failed to import HTML'
  },
  sessions: {
    eyebrow: 'Sessions',
    title: 'Sessions',
...
- Do not create flickering or large-scale shaking animations`
  ...
  sessionDetail: {
    ...
    pptxPreviewPreparing: 'Preparing PPTX preview',
    pptxPreviewDescription: 'A temporary PPTX will be generated and opened without overwriting the final export.',
    pptxPreviewReady: 'PPTX preview ready ({count} pages)',
    pptxPreviewOpened: 'Opened the temporary preview. Export officially after checking the result.',
    previewPptx: 'Preview PPTX',
    exportPptxDefault: 'High Fidelity',
    exportPptxEditableShapes: 'Editable Shapes',
