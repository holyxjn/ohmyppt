...
export const PAGE_SEMANTIC_STRUCTURE = [
  ...
  "",
  "结构示例（片段）：",
  "<section data-page-scaffold=\"1\" class=\"flex h-full min-h-0 flex-col gap-6 overflow-hidden\">",
  "  <header data-block-id=\"title\" data-role=\"title\" class=\"shrink-0 space-y-2\">",
  "    <h1 class=\"text-5xl font-bold\">页面标题</h1>",
  "    <p data-role=\"subtitle\" class=\"text-xl text-slate-500\">副标题</p>",
  "  </header>",
  "  <main data-block-id=\"content\" data-role=\"content\" class=\"grid min-h-0 flex-1 grid-cols-2 gap-6 overflow-hidden\">",
  "    <section data-block-id=\"metric-1\">...</section>",
  "    <section data-block-id=\"metric-2\">...</section>",
  "  </main>",
  "  <footer data-block-id=\"meta\" data-role=\"meta\" class=\"shrink-0 text-sm text-slate-500\">...</footer>",
  "</section>",
].join("\n");
