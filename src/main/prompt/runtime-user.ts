...
export function buildPlanningUserPrompt(args: {
  ...
  return [
    ...
    "",
    "Plan each slide title and key points. Use short phrases, not long paragraphs.",
    "Output must be a JSON array. Each item must be exactly { title, keyPoints }; keyPoints must contain 1-6 strings.",
